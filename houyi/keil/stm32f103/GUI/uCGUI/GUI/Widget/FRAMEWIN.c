...
#ifndef FRAMEWIN_BLTKOLOR_ACTIVE_DEFAULT
  #define FRAMEWIN_BLTKOLOR_ACTIVE_DEFAULT 0xFF0000
#endif

/* Default barcolor when framewin is inactive */
#ifndef FRAMEWIN_BLTKOLOR_INACTIVE_DEFAULT
  #define FRAMEWIN_BLTKOLOR_INACTIVE_DEFAULT 0x404040
#endif
...
FRAMEWIN_PROPS FRAMEWIN__DefaultProps = {
  ...
  FRAMEWIN_BLTKOLOR_INACTIVE_DEFAULT,
  FRAMEWIN_BLTKOLOR_ACTIVE_DEFAULT,
